...
%for cbad simple.
%extracts polygons of each part image then combine the polygon images
...
for orgInd = 34:length(orgsDir)
    ...
    if (contains(fileName,'.jpg'))
        ...
        page_bin = binarization(page,25,0);
        ...
        CbadSaveAllResults2Files( page,page_bin,whole_polygon_labels,fileName,dstPath);
