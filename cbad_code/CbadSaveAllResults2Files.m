function  CbadSaveAllResults2Files( I,bin,polygon_labels,merged_whole_blob_lines,fileName,dstPath,varargin)
    ...
    [~,LetterName,~] = fileparts(fileName);
     ...
     imwrite(bin,[dstPath,'/binary/',LetterName,'.png']);
     imwrite(merged_whole_blob_lines,[dstPath,'/blob_lines/',LetterName,'.png']);
